    ...
    <section className="bg-[#EFF6FF] px-4 py-16 sm:px-6 sm:py-20 lg:px-12 lg:py-24">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          >
            <span className="material-symbols-outlined" aria-hidden="true" style={{ fontSize: 18 }}>bolt</span>
          ...
          >
            <span className="material-symbols-outlined" aria-hidden="true" style={{ fontSize: 18 }}>manage_search</span>
